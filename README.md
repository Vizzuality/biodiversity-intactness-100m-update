...
Annual global 100m gridded maps of terrestrial Biodiversity Intactness, extended to 2017-2025.
...
on updated input datasets refreshing and extending the timeseries to 2017-2025.
...
database of >26,000 site observations ([Hudson et al. 2016](https://doi.org/10.5519/0066354)/[2017](https://doi.org/10.1002/ece3.2579))
...
|---|---|---|---|---|
| land cover | [Sentinel-2 10 m Land Use/Land Cover Time Series, 9-class](https://livingatlas.arcgis.com/landcoverexplorer/) (2017-2025) | Karra et al. 2021 | yes | yes |
...
| nightlights | [VIIRS Nighttime Lights (VNL), v2.1 / v2.2 annual median composites](https://eogdata.mines.edu/products/vnl/) (2017-2025) | Elvidge et al. 2021 | yes | yes |
...
| roads | [OpenStreetMap data extracts](https://download.geofabrik.de/) (2026-06-25) | OpenStreetMap contributors | no | yes |
